  ...
  return (
    <View style={{paddingTop: 10}}>
      <View style={styles.input_box_style}>
        <Text style={styles.input_label}>Reel Link </Text>
        <TextInput
          autoCapitalize="none"
          style={styles.inputText}
          value={inputData.real1}
          onChangeText={value => handleInputChange('real1', value)}
        />
      </View>
      <View style={styles.input_box_style}>
        <Text style={styles.input_label}>Reel Link </Text>
        <TextInput
          autoCapitalize="none"
          style={styles.inputText}
          value={inputData.real2}
          onChangeText={value => handleInputChange('real2', value)}
        />
      </View>
      <View style={styles.input_box_style}>
        <Text style={styles.input_label}>Story Link </Text>
        <TextInput
          autoCapitalize="none"
          style={styles.inputText}
          value={inputData.story1}
          onChangeText={value => handleInputChange('story1', value)}
        />
      </View>
      <View style={styles.input_box_style}>
        <Text style={styles.input_label}>Story Link </Text>
        <TextInput
          autoCapitalize="none"
          style={styles.inputText}
          value={inputData.story2}
          onChangeText={value => handleInputChange('story2', value)}
        />
      </View>
